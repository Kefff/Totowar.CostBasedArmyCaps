...
Like in skirmish battles, by default, player and AI armies have an initial budget of 12400 `Army Supplies`.  
...
Otherwise, you can disable restrictions in the mod's options (see the next section).

## Configuration
If you have installed Groove Wizard's [Mod Configuration Tool](https://steamcommunity.com/sharedfiles/filedetails/?id=2927955021), you can access options for customizing the mod's behavior in the game by clicking on the `cog` icon in the top left corner of the screen.  
You can choose to disable restrictions for the player or the AI, change the `Army Supplies` base budget, change the amount of `Army Supplies` gained per level, and adjust AI army target composition maximum percentages.

## Multiplayer compatibility
**The mod is very likely not compatible with a multiplayer campaign**.  
It has not been developed with multiplayer in mind, nor has it been tested in a multiplayer campaign.
